...
/**
 * Created by goodix on 17-1-6.
 */

public class LytChart extends FrameLayout {
    ...
    public LytChart(Context context) {
        super(context);
    }

    public LytChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        Log.e("aaaaaa", "aaaaa");
        mGridView = inflate(context, R.layout.item_lyt_chart, null);
        initData();
        initView();
        initGrid();
        setListeners();
    ...
    private void initView() {
        ...
        mGridHorizontalScrollView = (HorizontalScroller) mGridView.findViewById(R.id.real_time_data_col_count_horizontal_scrollView);
        mDataHorizontalScrollView = (HorizontalScroller) mGridView.findViewById(R.id.real_time_data_display_data_horizontal_scrollview);
        ...
        mColumnIdLayout = (LinearLayout) mGridView.findViewById(R.id.left_table);
        mTableIdLayout = (LinearLayout) mGridView.findViewById(R.id.table_id);
        mVerticalScrollView = (VerticalScroller) mGridView.findViewById(R.id.real_time_data_vertical_scrollView);
    }

    private void initGrid() {
        final GridDisplayView BlankView = new GridDisplayView(mContext, GRID_HEAD_TYPE, mBoxWidth, mBoxHeight);
        BlankView.setRowColCount(1, 1);
        mTableIdLayout.addView(BlankView);

        mColCountView = new GridDisplayView(mContext, REAL_TIME_DATA_TYPE, mBoxWidth, mBoxHeight);
        ...
        mRowCountView = new GridDisplayView(mContext, REAL_TIME_DATA_TYPE, mBoxWidth, mBoxHeight);
        ...
        mDataView = new GridDisplayView(mContext, REAL_TIME_DATA_TYPE, mBoxWidth, mBoxHeight);
